...
WindUI:Popup({
    Title = "Uzumaki - 99 Night in the Forest",
    Icon = "star",
    IconThemed = true,
    Content = "https://discord.gg/RHy5dh4KUV",
    Buttons = {
...
local Window = WindUI:CreateWindow({
    Folder = "Uzumaki Config | 99NitF | 99",
    Author = "STELLAR",
    Title = "Uzumaki Hub - 99 Night in the Forest",
    IconThemed = true,
    Icon = "star",
    Author = "Make by ph67_",
